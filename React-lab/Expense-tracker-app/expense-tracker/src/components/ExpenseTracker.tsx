...
class ExpenseTracker extends Component<Props, State> {
    constructor(props : Props){
        ...
        this.dateEntry = this.dateEntry.bind(this)
    }
    setDefaultDate = () =>{
    ...
    dateEntry = (e : ChangeEvent<HTMLInputElement>) => {
        this.setState({
            ...
            <>
               <section>
                 ...
                 <form onSubmit={this.submitForm}>
                   ...
                   <article>
                     <p>Date</p>
                     <input type="date" required value={this.state.setDate} onChange={this.dateEntry}/>
                   </article>
